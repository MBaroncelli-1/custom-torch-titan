...
def _load_fineweb_dataset(dataset_path: str, **kwargs):
    """Load FineWeb dataset from a local JSONL file."""
    logger.info(f"Loading FineWeb dataset from {dataset_path}...")
    return load_dataset(
        "json",
...
DATASETS = {
    ...
    "fineweb": DatasetConfig(
        path="json",                      # placeholder, verrà sovrascritto da dataset_path
